...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, layers, use_maks, no_modified = False):
        ...
        self.up1 = up(layers[3]+layers[4], layers[5],no_modified=no_modified)
        self.up2 = up(layers[5] + layers[2], layers[6],no_modified=no_modified)
        self.up3 = up(layers[6]+layers[1], layers[7],no_modified=no_modified)
        self.up4 = up(layers[7] + layers[0], layers[8],no_modified=no_modified)
